...
{
    public abstract class BackTemplateWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BackTemplateWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BackTemplateWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BackTemplateDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BackTemplateDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BackTemplateDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BackTemplateDbContext, Task<T>> func)
        {
            T result;
